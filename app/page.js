    ...
    <div className="relative min-h-screen bg-[#0a0a0a] text-white overflow-hidden font-sans">
      ...
      <div className="relative z-10 p-8 flex gap-6 max-w-6xl mx-auto bg-[rgba(0,0,0,0.4)]">
        <div className="flex-1">
              ...
              <div className="flex gap-2 mb-4">
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <rect x="4" y="6" width="2" height="12" fill="gray" />
                    <rect x="7" y="6" width="2" height="12" fill="gray" />
                    <rect x="10" y="6" width="2" height="12" fill="gray" />
                    <rect x="13" y="6" width="2" height="12" fill="gray" />
                    <rect x="16" y="6" width="2" height="12" fill="gray" />
                    <rect x="19" y="6" width="2" height="12" fill="gray" />
                  </svg>
                </button>
              </div>
            </div>
          ...
          <div className="bg-transparent mt-2 rounded overflow-hidden border border-cyan-600 w-full max-w-4xl h-[95vh] flex items-center justify-center">
            {layout === "single" && <canvas className="w-full h-full" />}
            {layout === "split" && (
              <div className="flex gap-3 w-full h-full">
                <canvas className="h-full border-[0.5px] border-cyan-500"  style={{ width: "80%" }} />
                <canvas className="h-full border-[0.5px] border-cyan-500" style={{ width: "20%" }} />
              </div>
            )}
            {layout === "five" && (
              <div className="flex gap-3 w-full h-full">
                {[...Array(5)].map((_, i) => (
                  <canvas
                    ...
                    className="h-full border-[0.5px] border-cyan-500"
                    style={{ width: "20%" }}
                  />
                ))}
              </div>
